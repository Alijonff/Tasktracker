  ...
  app.post("/api/tasks", requireAuth, async (req, res) => {
    try {
      ...
      const taskData: Partial<Task> = {
        ...
        earnedMoney: requestedTaskType === "INDIVIDUAL" && requestedMode === "MONEY" ? basePrice : null,
        earnedTimeMinutes: requestedTaskType === "INDIVIDUAL" && requestedMode === "TIME" ? baseTime : null,
        auctionEndAt: null,
